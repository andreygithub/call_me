  ...
  <div class="modal-dialog">
    <form class="modal-content form-horizontal" id="call_me" role="form" method="post" action="[[~[[*id]]]]">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="callme_comment" class="col-sm-4 control-label">Комментарий:</label>
          <div class="col-sm-8">
              <textarea class="form-control" name="comment" id="callme_comment" rows="3" placeholder=""></textarea>
          </div>
        </div>          
      </div>    
